...
class StableDiffusion3ControlNetPipeline(DiffusionPipeline, SD3LoraLoaderMixin, FromSingleFileMixin):
    ...
    # Copied from diffusers.pipelines.stable_diffusion_3.pipeline_stable_diffusion_3_controlnet.StableDiffusion3ControlNetPipeline.check_inputs
    def check_inputs(
        self,
        prompt,
        prompt_2,
    ...
    # Modify from diffusers.pipelines.stable_diffusion_3.pipeline_stable_diffusion_3_controlnet.StableDiffusion3ControlNetPipeline.prepare_image
    def prepare_image(
        self,
        image,
        width,
